...
public class BetOleF {
	
	private static final String POCETAK_URL_LEAGUE = "https://www.betole.com/restapi/offer/sr/sport/S/league/";
    private static final String KRAJ_URL_LEAGUE = "/mob?annex=0&mobileVersion=2.28.28&locale=sr";
    private static final String POCETAK_URL_MATCH = "https://www.betole.com/restapi/offer/sr/match/";
    private static final String KRAJ_URL_MATCH = "?annex=0&desktopVersion=2.28.28&locale=sr";
   ...
   // private static String savedMatchId;
    ...
    public static List<String> uzmiIdLiga() {
        ...
        try {
            String urlString = "https://www.betole.com/restapi/offer/sr/categories/top/l?annex=0&sport=S&desktopVersion=2.28.28&locale=sr";
    ...
    public static void dodajKladionicu(JSONArray matchesArray) {
        for (int i = 0; i < matchesArray.length(); i++) {
            ...
            matchData.put("Kladionica", "BetOle"); // Dodajemo informaciju o kladionici
        }
    }
