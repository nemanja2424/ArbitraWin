...
public class MaxbetK /*extends mobAnexInfo*/ {

    public static JSONArray praviAPI() {
        List<String> idLiga = uzmiIdLiga();

        String pocetakUrl = "https://www.maxbet.rs/restapi/offer/sr/sport/B/league/";
        String krajUrl = "/mob?annex=3&mobileVersion=1.0.1.22&locale=sr";
    ...
    public static List<String> uzmiIdLiga() {
        ...
        try {
            String urlString = "https://www.maxbet.rs/restapi/offer/sr/categories/sport/B/l?annex=3&mobileVersion=1.0.1.22&locale=sr";
