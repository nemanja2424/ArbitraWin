...
public class MerkurK {

	private static final String POCETAK_URL_LEAGUE = "https://www.merkurxtip.rs/restapi/offer/sr/sport/B/league/";
    private static final String KRAJ_URL_LEAGUE = "/mob?annex=0&mobileVersion=2.32.2.5&locale=sr";
    private static final String POCETAK_URL_MATCH = "https://www.merkurxtip.rs/restapi/offer/sr/match/";
    private static final String KRAJ_URL_MATCH = "?annex=0&mobileVersion=2.32.2.5&locale=sr";
    ...
    public static List<String> uzmiIdLiga() {
        ...
        try {
            String urlString = "https://www.merkurxtip.rs/restapi/offer/sr/categories/gl/B?annex=0&mobileVersion=2.32.2.5&locale=sr";
            ...
            for (int i = 0; i < matchesArray.length(); i++) {
                ...
                if (matchObject.has("home") && matchObject.has("away") && matchObject.has("kickOffTime")
                    ...
                    double Q1G_PLUS = oddsObject.optDouble("50030", 1);
						...
						matchDataObject.put("Kladionica", "Merku X Tip");
