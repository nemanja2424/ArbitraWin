...
public class MaxbetT /*extends mobAnexInfo*/ {

	private static final String POCETAK_URL_LEAGUE = "https://www.maxbet.rs/restapi/offer/sr/sport/T/league/";
    private static final String KRAJ_URL_LEAGUE = "/mob?annex=3&desktopVersion=1.0.1.1&locale=sr";
    private static final String POCETAK_URL_MATCH = "https://www.maxbet.rs/restapi/offer/sr/match/";
    private static final String KRAJ_URL_MATCH = "?annex=3&desktopVersion=1.0.1.1&locale=sr";
    ...
    public static List<String> uzmiIdLiga() {
        ...
        try {
            String urlString = "https://www.maxbet.rs/restapi/offer/sr/categories/sport/T/l?annex=3&desktopVersion=1.0.1.1&locale=sr";
