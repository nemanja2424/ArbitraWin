...
public class BetOleT {
	
	private static final String POCETAK_URL_LEAGUE = "https://www.betole.com/restapi/offer/sr/sport/T/league/";
   ...
   // private static String savedMatchId;
    ...
    public static List<String> uzmiIdLiga() {
        ...
        try {
            String urlString = "https://www.betole.com/restapi/offer/sr/categories/top/l?annex=0&offset=10&sport=T&mobileVersion=2.33.6.5&locale=sr";
